...
На сегодняшний день OpenStack содержит семь ключевых компонентов:
...
В данное руководство так же включена установка
	
	* :ref:`Распределенной файловой системы CEPH <filesystem>`
	* :ref:`Cистемы мониторинга Munin <munin>`
	* :ref:`Сервера доменных имен MyDNS <names>`
