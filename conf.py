# -*- coding: utf-8 -*-
#
# openstack documentation build configuration file, created by
...
project = u'openstack'
copyright = u'2013, Леонид Лабошин'
...
latex_documents = [
  ('index', 'openstack.tex', u'Руководство по установке и настройке OpenStack',
...
man_pages = [
    ('index', 'openstack', u'openstack Documentation',
     [u'Leonid Laboshin'], 1)
]
